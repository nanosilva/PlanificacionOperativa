...
@Component({
  selector: 'app-trazadoras1c2023',
  templateUrl: './trazadoras1c2023.component.html',
...
export class Trazadoras1c2023Component implements OnInit {
  ...
  ngOnInit(): void {
    this.datosPlanificacion.getTrazadoras1c23().subscribe(data=>{
  ...
  loadData(event: any) {
    if (this.trazadoras.municipio) {
      forkJoin([
        this.chartService.fromMunicipioTrz1c23(this.trazadoras.municipio).pipe(map(data => data.map(val => val.trazadora))),
        this.chartService.fromMunicipioTrz1c23(this.trazadoras.municipio).pipe(map(data => data.map(val => val.casos_positivos))),
        this.chartService.fromMunicipioTrz1c23(this.trazadoras.municipio).pipe(map(data => data.map(val => val.meta_casos))),
        this.chartService.fromMunicipioTrz1c23(this.trazadoras.municipio).pipe(map(data => data.map(val => val.meta_pct))),
        this.chartService.fromMunicipioTrz1c23(this.trazadoras.municipio).pipe(map(data => data.map(val => val.tasa_cobertura))),
        this.chartService.fromMunicipioTrz1c23(this.trazadoras.municipio).pipe(map(data => data.map(val => val.tcm))),
        this.chartService.fromMunicipioTrz1c23(this.trazadoras.municipio).pipe(map(data => data.map(val => val.cumple_tcm))),
        this.chartService.fromMunicipioTrz1c23(this.trazadoras.municipio).pipe(map(data => data.map(val => val.municipio))),
        this.chartService.fromMunicipioTrz1c23(this.trazadoras.municipio).pipe(map(data => data.map(val => val.periodo)))
